...
class Searcher:
    ...
    def search(self, k=2, threshold = 1):
        ...
        minutes = t/60
        seconds =  t%60
        print("time:", minutes,"minutes, ", seconds,"seconds", "totla time:", t)
...
def main():
    ...
    graph = Graph('../Files/json graphs/src2.json')
    searcher = Searcher(graph, query)
    # searcher.search()
    # searcher.get_results()
    searcher.calculate_similarities()
