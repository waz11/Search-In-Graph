...
def main():
    # query1 = Query("class list implements class iterable,class list contains class node")
    # graph1 = Graph('../Files/json graphs/src1.json')
    # searcher = Searcher(graph1, query1)

    query3 = Query("class Bases contains method xorHexes")
    graph3 = Graph('../Files/json graphs/src3.json')
    searcher = Searcher(graph3, query3)
